...
package re.org.eclipse.jetty.websocket.servlet;
...
public interface WebSocketServletFactory
{
    class Loader
    {
        static final String DEFAULT_IMPL = "re.org.eclipse.jetty.websocket.server.WebSocketServerFactory";

		public static WebSocketServletFactory load(ServletContext ctx, WebSocketPolicy policy)
        {
            WebSocketServerFactory factory = new WebSocketServerFactory(ctx, policy);
			return factory;
        }
    }
