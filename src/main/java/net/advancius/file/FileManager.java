...
public class FileManager {
    ...
    public static void load() {
        AdvanciusBungee.getInstance().getDataFolder().mkdirs();
    }
    ...
    public static InputStream getSourceFileStream(String path) {
        return AdvanciusBungee.getInstance().getResourceAsStream(path);
    }

    public static File getServerFile(String path) {
        return new File(AdvanciusBungee.getInstance().getDataFolder(), path);
    }
